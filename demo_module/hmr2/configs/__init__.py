    ...
    if update_cachedir:
      def update_path(path: str) -> str:
        if os.path.isabs(path):
          return path
        return os.path.join('pretrained/Human4D_data', path)

      cfg.SMPL.MODEL_PATH = R'data/smpl' #update_path(cfg.SMPL.MODEL_PATH)
      cfg.SMPL.JOINT_REGRESSOR_EXTRA = R'data/smpl/SMPL_to_J19.pkl' #update_path(cfg.SMPL.JOINT_REGRESSOR_EXTRA)
      cfg.SMPL.MEAN_PARAMS = R'data/smpl/smpl_mean_params.npz' #update_path(cfg.SMPL.MEAN_PARAMS)
