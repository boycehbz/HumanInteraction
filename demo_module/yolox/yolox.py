...
from demo_module.yolox.utils import fuse_model, get_model_info, postprocess
from demo_module.yolox.utils.visualize import plot_tracking, vis_bboxes
from demo_module.yolox.utils.timer import Timer
from demo_module.yolox.data.data_augment import preproc
...
class Predictor(object):
    ...
    def get_model(self, pretrained_model):
        from demo_module.yolox.models import YOLOPAFPN, YOLOX, YOLOXHead
