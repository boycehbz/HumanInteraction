...
def get_config(config_file: str, merge: bool = True, update_cachedir: bool = False) -> CN:
    ...
    if update_cachedir:
      ...
      cfg.SMPL.MODEL_PATH = R'smpl\smpl' #update_path(cfg.SMPL.MODEL_PATH)
      cfg.SMPL.JOINT_REGRESSOR_EXTRA = R'smpl\SMPL_to_J19.pkl' #update_path(cfg.SMPL.JOINT_REGRESSOR_EXTRA)
      cfg.SMPL.MEAN_PARAMS = R'smpl\smpl_mean_params.npz' #update_path(cfg.SMPL.MEAN_PARAMS)
